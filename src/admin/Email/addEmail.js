...
import { setTemplate } from "../../services/mails"
...
function AddEmail() {
        ...
        setTemplate(emailInfo, html)
            .then(() => {
                if (mounted.current) {
                    ...
                    setHtml("");
                    window.location.replace("/admin/dashboard/email/search")
                }
            })
    }
    ...
    return (
        <div className="centered">
            <h1 className="text-center">Add Email Template</h1>
            <form className="email-form">
                <div className="form-group ">
                    <label htmlFor="name">Enter name of template</label>
                    <input type="text" className="form-control" name="name" placeholder="Name" value={emailInfo.name} onChange={handleChange} />
                </div>
                <div className="form-group">
                    <label htmlFor="subject">Enter subject of template</label>
