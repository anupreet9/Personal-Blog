...
function EditPost() {
    ...
    useEffect(() => {
        document.title = "Edit Blog Post | Curly Haired Escapade"
    }, [])

    useEffect(() => {
        getSpecificPost(postId)
            .then(items => {
                setPost(items.content);
                setPostInput({
                    title: items.title,
    ...
    function handleSubmit(event) {
        ...
        editSpecificPost(postId, postInput, post)
            .then(() => {
                if (mounted.current) {
                    setAlert(true);
        ...
        <div className="centered">
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    <label htmlFor="title">Edit title of post</label>
                ...
                <div className="form-group">
                    <input type="checkbox" name="edit" id="checkbox" aria-label="Checkbox for following text input" onClick={onChecked} checked={edit}></input>
